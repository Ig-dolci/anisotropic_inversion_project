...
ou isotrópico em regiões em essencia anisotrópicas pode resultar em erros de imageamento \cite{AlkhalifahPlessix2014, AkiRichards2002}.
De acordo com \cite{Thomsen1986}, as causas de anisotropia em rochas, nesse caso superfícies rochosas, são  por exemplo quando há
Fraturas presentes nas rochas, sequência de finas camadas isotrópicas ou anisotrópicas (isto é, estratificação
...
Além disso, Keith et al. \cite{roberts2022spyro} implementaram solucionadores de elementos finitos de alta ordem triangulares (2D) e
...
com sistema de equações em grandes escalas (com em FWI 3D) apresenta desafios significativos de desempenho e consumo de memória. Investigar o
